export async function callGPT({ prompt }: { prompt: string }) {
    const messages = [
        // { role: 'system', content:
        //     `## INFO ##
        //     you can add images to the reply by URL,
        //     Write the image in JSON field Use the Unsplash API (https://source.unsplash.com/1600x900/?).
